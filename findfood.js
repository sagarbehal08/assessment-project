...
if(navigator.geolocation)
{
  ...
  //navigator.geolocation.getCurrentPositon(restro_name);
}
else {
        ...
        console.log(main);
         ...
         console.log(main);
          ...
          document.getElementById("btn").addEventListener("click", function(){
            var str=document.getElementById("restro_name").value;
            var str=str.toUpperCase();
            var count=0;
            for(var j=0;j<res_data.nearby_restaurants.length;j++)
            {
              var zrestro_name=res_data.nearby_restaurants[j].restaurant.name;
              var zrestro_name=zrestro_name.toUpperCase();
              if(zrestro_name===str)
              {
                var rem_restros=document.getElementById("main");
                while(rem_restros.hasChildNodes())
                {
              ...
              console.log(main);
               ...
               console.log(main);
                ...
                console.log(main);
                var text=document.createElement("h4")
                text.textContent=res_data.nearby_restaurants[j].restaurant.name;
                restro_name.appendChild(text);
                restaurant.appendChild(restro_name);
                console.log(main);
...
// function restro_search(position)
//     {
